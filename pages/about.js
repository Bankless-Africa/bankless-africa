    ...
    <div className="bg-black">
      ...
      <div className="flex flex-col">
          ...
          xl:pb-72 2xl:pb-80 px-8">
            ...
            <h1 className="text-center text-white lg:text-5xl sm:text-4xl md:text-6xl">We are on a quest to help 
          ...
          <div className="flex flex-col space-x-8">
            <div className="flex flex-col justify-center ml-9">
              <h1 className="mb-4 text-3xl font-bold text-white lg:text-5xl">Who We Are</h1>
              <div className="max-w-8"><Image src={underline} alt="underline" /></div>
            </div>
        ...
        <div data-aos="fade-up" data-aos-duration="10000" className="flex justify-center mx-16 mb-10 md:mx-10 lg:mx-24">
          ...
          <div className="flex flex-col flex-1 px-5 py-10 mx-4 text-center text-white bg-darkBlack rounded-xl">
              ...
              <div className="max-w-8"><Image src={underline} alt="underline" /></div>
              <div className="text-xs text-white sm:text-sm md:text-base lg:text-lg xl:text-xl">Our mission is to promote, educate and propagate truly bankless media,
          ...
          <div className="flex flex-col flex-1 px-5 py-10 mx-4 mt-5 text-center text-white bg-darkBlack rounded-xl sm:mt-0">
              ...
              <div className="max-w-8"><Image src={underline} alt="underline"  /></div>
              <div className="text-xs text-white sm:text-sm md:text-base lg:text-lg xl:text-xl">Our vision is to be a driving force for capacity building, economic

...
import box3 from '../../components/Podcast/Images/banklessAfrica-podcast.jpg';
    ...
    <div>
        ...
        <div class="container items-center">
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-10 my-12 sm:my-16">
            ...
            <div class="flex flex-col">
              ...
              <p className="text-xl mt-3 mb-3 text-white">
                ...
                <Dialog.Panel className="relative transform overflow-hidden rounded-lg cardbg px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                  ...
                  <div className="flex space-x-3 mt-10 mb-10">
                    <button className="flex items-center p-1 text-white border-2 border-white rounded-lg">
                      ...
                      <a
                        target="_blank"
                        href="https://podcasts.apple.com/us/podcast/pidgin-parlour-crypto-podcast/id1651579729"
                    ...
                    <button className="flex items-center p-1 text-white border-2 border-white rounded-lg">
                      ...
                      <a
                        target="_blank"
                        href="https://rss.com/podcasts/pidginparlour/"
                        className="text-sm ml-2"
                      >
                        {' '}
                        Rss Podcast
                    ...
                    <button className="flex items-center p-1 text-white border-2 border-white rounded-lg">
                      ...
                      <a
                        target="_blank"
                        href="https://www.podbean.com/podcast-detail/4xqnz-28b6b5/Pidgin-Parlour-Crypto-Podcast"
                        className="text-sm ml-2"
                      >
                        {' '}
                        Podbean
                    ...
                    <button className="flex items-center p-1 text-white border-2 border-white rounded-lg">
                      ...
                      <a
                        target="_blank"
                        href="https://open.spotify.com/show/3hDjVgNS0pj0eJY7V9Q2wf"
                        className="ml-2"
                      >
                        {' '}
                        Spotify
                  ...
                  <div className="flex space-x-3 mt-10 mb-10">
                    <button className="flex items-center p-1 text-white border-2 border-white rounded-lg">
                      ...
                      <a
                        target="_blank"
                        href="https://podcasts.google.com/feed/aHR0cHM6Ly9tZWRpYS5yc3MuY29tL3BpZGdpbnBhcmxvdXIvZmVlZC54bWw"
                        className="text-sm ml-2"
                      >
                        {' '}
                        Google podcast
                ...
                <Dialog.Panel className="relative transform overflow-hidden rounded-lg cardbg px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                  ...
                  <div className="flex space-x-3 mt-10 mb-10">
                    <button className="flex items-center p-1 text-white border-2 border-white rounded-lg">
                      ...
                      <a
                        target="_blank"
                        href="https://podcasts.apple.com/us/podcast/bankless-africa-podcast/id1624660286"
                        className="text-sm ml-2"
                      >
                        {' '}
                        apple Podcast
                    ...
                    <button className="flex items-center p-1 text-white border-2 border-white rounded-lg">
                      ...
                      <a
                        target="_blank"
                        href="https://open.spotify.com/show/3p7wy8sbpERj13oSl72CQ6"
                        className="ml-2"
                      >
                        {' '}
                        Spotify
                  ...
                  <div className="flex space-x-3 mt-10 mb-10">
                    <button className="flex items-center p-1 text-white border-2 border-white rounded-lg">
                      ...
                      <a
                        target="_blank"
                        href="https://podcasts.google.com/feed/aHR0cHM6Ly9mZWVkLnBvZGJlYW4uY29tL2JhbmtsZXNzYWZyaWNhL2ZlZWQueG1s?sa=X&ved=0CAMQ4aUDahcKEwjwkuC6gNX9AhUAAAAAHQAAAAAQCA"
                        className="text-sm ml-2"
                      >
                        {' '}
                        Google podcast
      ...
      <Transition.Root show={Readmore} as={Fragment}>
        <Dialog
          as="div"
          className="relative z-10"
          initialFocus={cancelReadmoreRef}
          onClose={setReadmore}
        >
          <Transition.Child
            as={Fragment}
                ...
                <Dialog.Panel className="relative transform overflow-hidden rounded-lg cardbg px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                  <div>
                    ...
                    <div className="text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-white">
                          Pidgin Parlor na centre of crypto education and
                          culture for the African pipul wey dey speak Pidgin.
                          The show go dey break down plenti crypto concepts wey
                          just dey confuse person into simple forms wey everyday
                          African go fit dey relate with. And all these things
                          go dey for pidgin, the localized language wey over 75
                          million Africans dey speak. This pidgin parlour crypto
                          podcast dey bring crypto education and culture come
                          inside street."Pidgin Parlour is the centre of crypto
                          education and culture for the everyday pidgin-speaking
                          African. The show breaks down complex crypto concepts
                          into bite-size, easy and simple-to-digest content for
                          the everyday African. And this is all done in pidgin,
                          a localised English spoken by over 75 million
                          Africans. Piding Parlour Crypto Podcast brings crypto
                          education and culture to the streets
                        </p>
                      </div>
                    </div>
                  </div>

...
const PodCard = () => {
  ...
  return (
        ...
        <div class="container items-center">
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-10 my-12 sm:my-16">
            ...
            <div class="flex flex-col">
              ...
              <div className="flex space-x-4 mt-10">
                <button onClick={() => setOpen1(!Open1)} className="flex items-center p-3 text-white border-2 border-white rounded-lg">
                  <span>
                    <SpeakerWaveIcon className="h-6 w-6 text-white" />
                  </span>
                  <p className="ml-2"> Listen on...</p>
        ...
        <div class="container items-center">
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-10 my-12 sm:my-16">
            ...
            <div class="flex flex-col">
              ...
              <div className="flex space-x-4 mt-10">
                <button onClick={() => setOpen2(!Open2)} className="flex items-center p-3 text-white border-2 border-white rounded-lg">
                  <span>
                    <SpeakerWaveIcon className="h-6 w-6 text-white" />
                  </span>
                  <p className="ml-2"> Listen on...</p>
    ...
    <Transition.Root show={Open1} as={Fragment}>
      <Dialog as="div" className="relative z-10" initialFocus={cancelButtonRef} onClose={setOpen1}>
        <Transition.Child
          as={Fragment}
          enter="ease-out duration-300"
          enterFrom="opacity-0"
